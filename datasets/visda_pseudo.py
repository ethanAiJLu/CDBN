...
class Visda2017Pseudo(DatasetBase):
    """Office-Home.
    ...
    def __init__(self, cfg):
        ...
        if cfg.U_NUM_SHOTS > 0:
            train_u = self.sample_num_shots(train_u,cfg.U_NUM_SHOTS)
    ...
    def _read_data_support_target(self, input_domains):
        items = []
        path = "/home/lyg/fsda/datasets/visda/zeroshotrefer"
        data_by_class = {}
